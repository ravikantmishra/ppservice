 ...
 * Added: Sanchit Puri 
 * Scope: Feedback Entity class used to set the form fields and validate the fields data 
 * Dated: 05-09-2013
 */
...
class Feedback
{
    ...
    /**
     * used to set the entity fields entered on the feedback view form by user
     *
     * @param unknown $data            
     */
