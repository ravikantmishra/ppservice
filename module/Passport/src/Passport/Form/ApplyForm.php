<?php
/*
 * Organization: OSSCube Added: Ramandeep Singh Scope: Apply form for client
...
class ApplyForm extends Form
{
    ...
    public function __construct($values = null)
    {
        ...
        $this->add(
            array('type' => 'Zend\Form\Element\Select', 
                'attributes' => array('type' => 'select', 'id' => 'country', 
                    'value' => '0', 'onChange' => 'checkCountry(this.value);'), 
                'name' => 'country', 
                'options' => array('label' => 'Processing Country:', 
                    'value_options' => $values)));
        
        $this->add(
            array('name' => 'btnSubmit', 
